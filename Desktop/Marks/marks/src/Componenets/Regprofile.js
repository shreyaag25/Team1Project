...
useEffect(() => {
  axios.get("http://localhost:1111/stuprof", {
      params: {
        id: id
      }
    })
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          ...
          <div class="card-header bg-transparent text-center">
            <img class="profile_img" src={fac} alt="student dp"/>
    ...
    <div>
        <div class="card card-2 shadow-sm">
          <div class=" card-header-1 bg-transparent border-0">
            <br/>
            <h2 class="mb-0"><center>Subjects Studying</center></h2>
          </div>
          <br/>
         {/* <center> */}
         <div className='subs'>
