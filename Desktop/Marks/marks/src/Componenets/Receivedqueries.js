...
// import "bootstrap-icons/font/bootstrap-icons.css";
export default function Receivedqueries() {
...
//     })
// }
axios.post("http://localhost:1111/recreqq",{
     params:{}
}).then((response) => { 
...
if( res == null ){
  ...
  <div className="tab">
   ...
   {/* <div className="App">
      <button onClick={handleSubmit}>GetStudentData</button>
       ...
       <center><h1 className='ho1 hoo'>Queries</h1></center> 
   </>
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Query {re}</h4>
      <br/>
      <p class="card-text">Student Id : 2100030559</p>
      <p class="card-text">Query : {obj.query}</p>
